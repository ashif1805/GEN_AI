...
public class TestUtility {
	...
	@LazyAutowired
	private ACEAppConfig aceAppConfig;
	@LazyAutowired
	...
	public void createNewTestEvidence(String docName) throws Exception {
		if (this.environmentProperties.isEnableTestEvidence()) {
			String docFilePath = System.getProperty("user.dir") + aceAppConfig.getTestEvidenceFolder();
	...
	public void addingScreenShoot(String docName, String screenShootCaption, WebDriver webDriver) throws Exception {
		if (this.environmentProperties.isEnableTestEvidence()) {
			...
			String docFilePath = System.getProperty("user.dir") + aceAppConfig.getTestEvidenceFolder() + "\\" + docName;
